...
import static fr.inova.saxparser.parser.ContactsSaxParser.parseXmlFile;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertThrows;

class ContactsSaxParserTest {

    @Test
    public void parseXmlFile_validFilePath_xmlParsed() throws Exception {
        // Given
        var filePath = ContactsSaxParserTest.class.getClassLoader().getResource("contacts.xml").getPath();
